	...
	<table align="center" cellpadding="0" cellspacing="0" width="600" style="border: 1px solid #eee;">
 		...
 		<tr>
  			<td bgcolor="#ffffff" style="padding: 30px 20px 30px 20px; color: #153643; font-family: Arial, sans-serif; font-size: 16px; line-height: 20px; border-bottom: 5px solid #eee;">
  				<h2>Forgot Password Transaksi !</h2>
				<p>Silahkan klik link berikut untuk reset password: <br>
					<a href="{{$link}}" class="m_76583297770711390button m_76583297770711390button-primary" style="font-family:Avenir,Helvetica,sans-serif;box-sizing:border-box;border-radius:3px;color:#fff;display:inline-block;text-decoration:none;background-color:#3097d1;border-top:10px solid #3097d1;border-right:18px solid #3097d1;border-bottom:10px solid #3097d1;border-left:18px solid #3097d1" target="_blank">Reset Password</a>
				</p>
  			</td>
 		</tr>
 		<tr>

    ...
    <div class="row">
        <div class="col-md-12">
            ...
            <div class="page-title">
			    <h4 class="breadcrumb-header">Manage Member Transaksi Hotlist</h3>
			</div>
                ...
                <div class="panel-body">
                    <div class="table-responsive">
                        <table class="table table-striped">
                            ...
                            <tbody>
                            @if($hotlistmember->count() > 0)
                                @foreach ($hotlistmember as $d)
                               <tr>
                                    <td><center>{{$d->user->id}}</center></td>
                                    <td><center>{{$d->user->name}}</center></td>
                                    <td><center>{{$d->trans_hotlist_amount}}</center></td> 

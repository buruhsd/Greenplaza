        ...
        <div class="col-md-12">
          <div class="panel panel-white">
            <div class="panel-heading clearfix">
              <p>Tambah Grade Member</p>
            </div>
              <div class="panel-body">
                  <form class="form-horizontal" method="POST" action= "{{route('admin.konfigurasi.add_grademember')}}" enctype = "multipart/form-data">
                    {{ csrf_field() }}
            ...
            <div class="panel-heading clearfix">
              ...
              <div class="panel-body">
                ...
                @foreach ($grade as $key => $g)
                  <form class="form-horizontal" method="POST" action= "{{route('admin.konfigurasi.update_grademember', $g->id)}}" enctype = "multipart/form-data">
                    {{ csrf_field() }}
                      ...
                      <div class="form-group">
                          ...
                          <div class="col-sm-2">
                              <a href="{{route('admin.konfigurasi.delete_grademember', $g->id)}}"><button type="button" class="btn btn-danger" style="width: 100%">Hapus</button></a>
                          </div>
                      </div>
                  </form>
                @endforeach

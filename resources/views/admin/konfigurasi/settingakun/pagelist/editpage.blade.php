                  ...
                  <form class="form-horizontal" method="POST" action= "{{route('admin.konfigurasi.edit_page_add', $page->id)}}" enctype = "multipart/form-data">
                    {{ csrf_field() }}
                      <div class="form-group">
                          ...
                          <div class="col-sm-10">
                              <input type="text" class="form-control" style="color: #A9A9A9" name="page_judul" value="{{$page->page_judul}}">
                          </div>
                      </div>
                      <div class="form-group">
                        <label for="input-Default" class="col-sm-2 control-label">Page Role_id</label>
                        <div class="col-sm-10">
                            <select type="text" name="page_role_id" class="form-control">
                      ...
                      <div class="form-group">
                          ...
                          <div class="col-sm-10">
                              <select align="left"  class="form-control" name="page_kategori">
                      ...
                      <div class="form-group">
                          ...
                          <div class="col-sm-10">
                            <textarea class="form-control" name="page_text" placeholder="" rows="16" id="" >{!!$page->page_text!!}</textarea>
                          </div>
                      </div>

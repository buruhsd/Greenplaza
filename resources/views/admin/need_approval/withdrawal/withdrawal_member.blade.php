                        ...
                        <table class="table">
                            ...
                            @if($with->count() > 0)
                                ...
                                <tr>
                                    ...
                                    <td>
                                    @if($w->withdrawal_status == 0)
                                        <button type="button" class="btn btn-success btn-xs" data-toggle="modal" data-target="#exampleModalappv{{$w->id}}">Approve</button>
                                        <button type="button" class="btn btn-danger btn-xs" data-toggle="modal" data-target="#exampleModal{{$w->id}}">Reject</button></center>
                                    @elseif($w->withdrawal_status == 1)

                ...
                <div class="panel-heading clearfix">
                    ...
                    <div class="col-md-4"> 
                        <select id="select-baris" type="text" class="form-control">
                            ...
                            <option value="/admin/needapproval/baris_pembeli">Menunggu Review</option>
                            <option value="/admin/needapproval/baris_seller">Aktif</option>
                            <option value="/admin/needapproval/baris_seller">Ditolak</option>
                        </select>
                    </div>
                </div>

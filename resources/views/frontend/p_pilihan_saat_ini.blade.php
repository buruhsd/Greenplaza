...
@section('content')
    ...
    <div class="breadcumb-area req-all">
        <div class="container">
            <div class="row">
                <div class="col-12">
                    <h4 class="pull-right" style="padding: 10px">Produk Pilihan Saat Ini</h4>
                    ...
                    <div class="shop-area">
                        ...
                        <div class="row mb-30">
                            ...
                            <div class=" col-lg-5 col-sm-5 col-12">
                                <p class="total-product">
                                    {{($p_pilihan_saat_ini->currentPage() - 1) * $p_pilihan_saat_ini->perPage() + 1}}-
                                    {{$p_pilihan_saat_ini->perPage() * $p_pilihan_saat_ini->currentPage()}} 
                                    dari {{$p_pilihan_saat_ini->count()}} Data
                                </p>
                            </div>
                        ...
                        <div class="tab-content">
                            <div class="tab-pane active" id="grid">
                                ...
                                @else
                                @foreach($p_pilihan_saat_ini as $item)
                                            ...
                                            <div class="product-content tambahan">
                                                ...
                                                @if($item->produk_discount > 0)
                                                    <p>
                                                        ...
                                                        <span class="style-cost-item-front">Rp.{{FunctionLib::number_to_text_idr($item->produk_price-($item->produk_price * $item->produk_discount / 100))}}</span><br>
                                                ...
                                                @else
                                                    <p>
                                                        <span class="style-cost-item-front">Rp.{{FunctionLib::number_to_text_idr($item->produk_price, 0)}}</span><br>
                                ...
                                @endif
                                    <div class="col-12">
                                    {!! $p_pilihan_saat_ini->appends(['cat' => Request::get('cat'), 'src' => Request::get('src'), 'order' => Request::get('order')])->render() !!}

    ...
    <div class="slidebar-product-wrap">
        ...
        <div class="product-sidebar-items fix" onclick="javascript:window.location.href='{{route('detail', $r->produk_slug)}}'">
            ...
            <div class="product-sedebar-content fix">
                ...
                <p>
                    <span class="style-cost-discount-item-front">Rp.{{FunctionLib::number_to_text_idr($r->produk_price-($r->produk_price * $r->produk_discount / 100))}}</span>
    ...
    <div class="slidebar-product-wrap">
        ...
        <div class="product-sidebar-items fix" onclick="javascript:window.location.href='{{route('detail', $r->produk_slug)}}'">
            ...
            <div class="product-sedebar-content fix">
                ...
                <p>
                    <span class="style-cost-discount-item-front">Rp.{{FunctionLib::number_to_text_idr($r->produk_price-($r->produk_price * $r->produk_discount / 100))}}</span>
                    <del class="style-costt-item-front">Rp.{{FunctionLib::number_to_text_idr($r->produk_price, 0)}}</del>
                </p>
                @else
                <p>
                    <span class="style-cost-item-front">Rp.{{FunctionLib::number_to_text_idr($r->produk_price, 0)}}</span>
                </p>
                @endif
            </div>
        </div>

<div class="propuler-product-active next-prev-style owl-carousel">
    ...
    <div class="product-wrap">
        ...
        <div class="product-content">
            ...
            <p>
                <del class="style-cost-discount-item-front">Rp.{{FunctionLib::number_to_text($d->produk_price, 2)}}</del><span> </span><span class="pull-right" style="color:red">{{number_format($d->produk_discount)}} %</span><br>
                <span class="style-cost-item-front">Rp.{{FunctionLib::number_to_text($d->produk_price-($d->produk_price * $d->produk_discount / 100))}}</span>
            </p>
            @else
            <p>
                <span class="style-cost-item-front">Rp.{{number_format($d->produk_price, 2)}}</span>
            </p>
            @endif
            <ul class="rating">
                @if($d->avg_star())

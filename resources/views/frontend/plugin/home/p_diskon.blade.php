        ...
        <div class="product-sidebar-items fix">
            <div class="product-sidebar-img black-opacity" onclick="javascript:window.location.href='{{route('detail', $d->produk_slug)}}'">
                <a href="{{route('detail', $d->produk_slug)}}">
                    <img class="lazy" src="{{asset('assets/images/product/thumb/'.$d->produk_image)}}" style="width: 70px" onerror="this.src='{!!asset("assets/images/product/nopic.png")!!}'" alt="" data-src="{{asset('assets/images/product/thumb/'.$d->produk_image)}}" data-srcset="{{asset('assets/images/product/thumb/'.$d->produk_image)}} 2x, {{asset('assets/images/product/thumb/'.$d->produk_image)}} 1x" />
                </a>
            </div>

        ...
        <div class="product-sidebar-items fix">
            <div class="product-sidebar-img black-opacity" onclick="javascript:window.location.href='{{route('detail', $t->produk_slug)}}'">
                <a class="readmore" href="{{route('detail', $t->produk_slug)}}">
                    <img class="lazy" src="{{asset('assets/images/product/thumb/'.$t->produk_image)}}" style="width: 70px" onerror="this.src='{!!asset("assets/images/product/nopic.png")!!}'" alt=""data-src="{{asset('assets/images/product/thumb/'.$t->produk_image)}}" data-srcset="{{asset('assets/images/product/thumb/'.$t->produk_image)}} 2x, {{asset('assets/images/product/thumb/'.$t->produk_image)}} 1x"  />
                </a>
            </div>

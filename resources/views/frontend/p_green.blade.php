                    ...
                    <div class="shop-area">
                        ...
                        <div class="row mb-30">
                            ...
                            <div class=" col-lg-5 col-sm-5 col-12">
                                <p class="total-product">
                                    {{($p_green->currentPage() - 1) * $p_green->perPage() + 1}}-
                                    {{$p_green->perPage() * $p_green->currentPage()}} 
                                    dari {{$p_green->count()}} Data
                                </p>
                            </div>
                        ...
                        <div class="tab-content">
                            <div class="tab-pane active" id="grid">
                                ...
                                @endif
                                    <div class="col-12">
                                    {!! $p_green->appends(['cat' => Request::get('cat'), 'src' => Request::get('src'), 'order' => Request::get('order')])->render() !!}

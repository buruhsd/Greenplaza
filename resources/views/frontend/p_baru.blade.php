...
@section('content')
    ...
    <div class="breadcumb-area req-all">
        <div class="container">
            <div class="row">
                <div class="col-12">
                    <h4 class="pull-right" style="padding: 10px">Produk Baru</h4>
                    ...
                    <div class="shop-area">
                        ...
                        <div class="row mb-30">
                            ...
                            <div class=" col-lg-5 col-sm-5 col-12">
                                <p class="total-product">
                                    {{($p_baru->currentPage() - 1) * $p_baru->perPage() + 1}}-
                                    {{$p_baru->perPage() * $p_baru->currentPage()}} 
                                    dari {{$p_baru->count()}} Data
                                </p>
                            </div>
                        ...
                        <div class="tab-content">
                            <div class="tab-pane active" id="grid">
                                ...
                                @endif
                                    <div class="col-12">
                                    {!! $p_baru->appends(['cat' => Request::get('cat'), 'src' => Request::get('src'), 'order' => Request::get('order')])->render() !!}

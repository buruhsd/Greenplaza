                ...
                <div class="col-lg-12">
                    <div class="checkout-form p-10 border">
                        ...
                        <form action="checkout">
                            ...
                            <input type="button" onclick='modal_get($(this));' data-toggle='modal' data-method='get' data-href={{route("localapi.midtrans.payment")}} value="Pesan dengan Midtrans" class="btn btn-success" id="btn-pick-address" />
                            <input type="button" onclick='modal_get($(this));' data-toggle='modal' data-method='get' data-href={{route("localapi.masedi.payment")}} value="Pesan dengan Masedi" class="btn btn-success" id="btn-pick-address" />

...
@section('content')
    ...
    <div class="breadcumb-area req-all">
        <div class="container">
            <div class="row">
                <div class="col-12">
                    <h4 class="pull-right" style="padding: 10px">Green Production</h4>
                    ...
                    <div class="shop-area">
                        ...
                        <div class="row mb-30">
                            ...
                            <div class=" col-lg-5 col-sm-5 col-12">
                                <p class="total-product">
                                    {{($p_baru_saat_ini->currentPage() - 1) * $p_baru_saat_ini->perPage() + 1}}-
                                    {{$p_baru_saat_ini->perPage() * $p_baru_saat_ini->currentPage()}} 
                                    dari {{$p_baru_saat_ini->count()}} Data
                                </p>
                            </div>
                        ...
                        <div class="tab-content">
                            <div class="tab-pane active" id="grid">
                                ...
                                @else
                                @foreach($p_baru_saat_ini as $item)
                                ...
                                @endif
                                    <div class="col-12">
                                    {!! $p_baru_saat_ini->appends(['cat' => Request::get('cat'), 'src' => Request::get('src'), 'order' => Request::get('order')])->render() !!}

...
<div id="main-wrapper">
    <div class="page-title">
        <h3 class="breadcrumb-header">{{__('dashboard.alamat_seller') }}</h3>
    </div>
    <div class="panel panel-white">
                <div class="panel-heading clearfix">
                    <h4 class="panel-title">{{__('dashboard.ubah_alamat_seller') }}</h4>
                </div>
                                    ...
                                    <div class="col-md-12">
                                        <div class="row">
                                            <div class="form-group  col-md-3">
                                                <label for="user_detail_province">{{__('dashboard.provinsi') }}</label>
                                            ...
                                            <div class="form-group  col-md-3">
                                                <label for="user_detail_city">{{__('dashboard.kabupaten') }}</label>
                                            ...
                                            <div class="form-group  col-md-3">
                                                <label for="user_detail_subdist">{{__('dashboard.kecamatan') }}</label>
                                            ...
                                            <div class="form-group col-md-3">
                                                <label for="user_detail_pos">{{__('dashboard.kode_pos') }}</label>
                                            ...
                                            <div class="form-group col-md-12">
                                                <label for="user_detail_address">{{__('dashboard.address') }}</label>

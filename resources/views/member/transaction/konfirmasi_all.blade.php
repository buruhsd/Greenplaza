        ...
        <div class="col-md-12">
            ...
            <div class="panel panel-white">
                <div class="panel-body">
                    ...
                    <input type="button" onclick='modal_get($(this));' data-toggle='modal' data-method='get' data-href={{route("localapi.midtrans.re_payment_code", $trans->first()->trans_code)}} value="Pay" class="btn btn-success" id="btn-pick-address" />
                </div>
            </div>
        </div>
        </div>

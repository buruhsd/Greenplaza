...
<div class="page-title">
    <h3 class="breadcrumb-header">Iklan Slider</h3>
</div>
<div id="main-wrapper"> 
    ...
    <div class="panel panel-white">
        <a href="{{route('member.iklan.add_slider')}}" class="btn btn-default">Post Iklan Slider</a>
    </div>                        
    <div class="row">
        <div class="col-lg-12 col-md-12">
            <div class="panel panel-white">
                <div class="panel-heading clearfix">
                    <h4 class="panel-title">Iklan Slider</h4>
                </div>

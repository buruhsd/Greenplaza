            ...
            <div class="panel panel-white">
                <div class="panel-body">
                    <div class="large-6 medium-6 small-12 columns">
                        ...
                        <h2 style="">Rp '.FunctionLib::number_to_text($trans->trans_iklan_amount).'</h2>
                        ';
                        ?>
                    </div>
                    <hr>
                            ...
                            <div id="grosir" class="collapse">
                                <table class="table table-bordered table-striped table-highlight m-t-xs">
                                    <tbody id="grosir_row">
                                        <tr>
                                            <td>
                                            @if(empty($trans->trans_iklan_qr))
                                                <a href='{{route("member.iklan.generate_qr", $trans->id)}}' class="btn btn-success" >Generate</a>
                                                <i class="fa fa-arrow-right"></i>
                                            @endif
                                                <input type="button" onclick='modal_get($(this));' data-toggle='modal' data-method='get' data-href='{{route("localapi.masedi.qr_iklan", $trans->trans_iklan_code)}}' value="Bayar" class="btn btn-success" id="btn-pick-address" />
                                            </td>
                                        </tr>
                                    </tbody>
                                </table>

        ...
        <div class="col-md-12">
            ...
            <div class="panel panel-white">
                <div class="panel-body">
                    ...
                    <div class="col-md-12">
                        <button class="btn btn-success" id="pay" data-href='{{route("member.iklan.bayar_saldo", $trans->trans_iklan_code)}}'>Bayar</button>
                    </div>
...
<script type="text/javascript">
    $('#pay').click(function(e){
        swal({
            ...
            if (isConfirm.value){
                $.post($('#pay').data('href'), $("#form-pay-iklan").serialize(), function( data ) {

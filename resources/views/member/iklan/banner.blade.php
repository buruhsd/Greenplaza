...
<div class="page-inner">
    <div class="page-title">
        <h3 class="breadcrumb-header">Iklan Banner</h3>
    </div>
    <div id="main-wrapper"> 
        ...
        <div class="panel panel-white">
            <a href="{{route('member.iklan.add_banner')}}" class="btn btn-default">Post Iklan Banner</a>
        </div>                        
        <div class="row">
            <div class="col-lg-12 col-md-12">
                <div class="panel panel-white">
                    <div class="panel-heading clearfix">
                        <h4 class="panel-title">Iklan Banner</h4>
                    </div>

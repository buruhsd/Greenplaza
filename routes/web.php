...
Route::post('note_seller/{code}', 'Member\\TransactionController@note_seller');
...
Route::group(['prefix' => 'localapi', 'as' => 'localapi', 'namespace' => 'LocalApi'], function () {
	...
	Route::group(['prefix' => 'modal', 'as' => '.modal'], function () {
		...
		Route::group(['middleware' => ['is_active']], function () {
			...
			Route::post('res_kom_transDetail/{id}', 'ModalController@res_kom_transDetail')->name('.res_kom_transDetail');
			Route::post('res_kom_transDetail_admin/{id}', 'ModalController@res_kom_transDetail_admin')->name('.res_kom_transDetail_admin');
			Route::post('res_kom_transDetail_post/{id}', 'ModalController@res_kom_transDetail')->name('.res_kom_transDetail_post');

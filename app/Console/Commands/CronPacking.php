...
class CronPacking extends Command
{
    ...
    public function handle()
    {
        // log cron
        $data_cron = [
            'cron_job_method' => 'trans:packing',
            'cron_job_type' => 'start',
            'cron_job_status' => 1,
            'cron_job_title' => 'Transaksi Memulai Packing',
            'cron_job_note' => 'memulai mengecek transaksi menunggu seller memulai.'
        ];
        ...
        if($trans_detail->count()){
            ...
            $data_cron = [
                ...
                'cron_job_status' => 1,
                'cron_job_title' => 'Transaksi Memulai Packing',
                'cron_job_note' => 'transaksi dengan status menunggu Packing tersedia.'
            ];
            FunctionLib::add_cron($data_cron);
